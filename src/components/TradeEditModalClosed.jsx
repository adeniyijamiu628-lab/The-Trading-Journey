...
      dateString && typeof dateString === 'string' && dateString.includes("T")
...
    // 2. Format Time (FIXED: Uses the new 'trade_time' column)
    // Checks for trade.trade_time (from DB) or fallback to the old trade.tradeTime prop
    const tradeTimeString = trade.trade_time || trade.tradeTime; 
    const formattedTime = tradeTimeString && typeof tradeTimeString === 'string'
      ? tradeTimeString.substring(0, 5) // Extracts HH:MM
      : ""; 
...
      tradeTime: formattedTime, // Now correctly pre-fills
